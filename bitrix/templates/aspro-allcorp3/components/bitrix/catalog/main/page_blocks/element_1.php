	...
	<div class="catalog-detail__item flex-1">
		<?$APPLICATION->IncludeComponent(
			...
			Array(
                ...
                "T_TECHAR" => ($arParams["T_TECHAR"] ? $arParams["T_TECHAR"] : GetMessage("T_TECHAR")),
                "T_INSTRUCT" => ($arParams["T_INSTRUCT"] ? $arParams["T_INSTRUCT"] : GetMessage("T_INSTRUCT")),
                "T_PRICE" => ($arParams["T_PRICE"] ? $arParams["T_PRICE"] : GetMessage("T_PRICE")),
